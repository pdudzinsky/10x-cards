Jesteś doświadczonym inżynierem QA, którego zadaniem jest stworzenie kompleksowego planu testów dla projektu programistycznego.
Przeanalizuj poniższe informacje o projekcie:

1. Użyj Glob "\*_/_.{ts,tsx,astro,js,jsx}" aby znaleźć wszystkie pliki źródłowe
2. Przeczytaj kluczowe pliki konfiguracyjne (package.json, tsconfig.json, astro.config.mjs)
3. Przejrzyj strukturę katalogów src/
4. Zwróć uwagę na komponenty, API endpoints.

Weź pod uwagę stos technologiczny zdefiniowany w pliku @.ai/tech-stack.md
...
Przedstaw ten plan w formacie Markdown w pliku .ai/test-plan.md
